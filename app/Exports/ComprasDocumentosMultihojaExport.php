...
class ComprasDocumentosMultihojaExport implements WithMultipleSheets
{
    protected $detalle;
    ...
    public function sheets(): array
    {
        ...
        foreach ($this->detalle as $empresa => $rows) {
            ...
            $sheets[$empresa] = new ComprasDocumentosDetalleExport($rows, $empresas[$empresa]);
        }


        // foreach ($agrupado as $empresa => $rows) {

        //     $sheets[] = new ComprasDocumentosDetalleExport(
        //         $rows,
        //         $empresa
        //     );
        // }

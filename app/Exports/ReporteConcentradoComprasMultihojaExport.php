...
class ReporteConcentradoComprasMultihojaExport implements WithMultipleSheets
{
    protected $detalle;
    ...
    public function sheets(): array
    {
        ...
        foreach ($this->detalle as $empresa => $rows) {
            ...
            $sheets[$empresa] = new ReporteConcentradoComprasDetalleExport($rows, $empresas[$empresa]);
        }

...
/**
    ...
    public function rules(): array
    {
        return [
            ...
            'data.c_c' => 'required|integer',
            'data.sistema' => 'required|integer',
    ...
    public function messages()
    {
        return[
            ...
            'data.sistema.required' => 'Sistema del vehiculo es requerido',
            'data.tipoMantenimiento.required' => 'Tipo de mantenimiento es requerido',

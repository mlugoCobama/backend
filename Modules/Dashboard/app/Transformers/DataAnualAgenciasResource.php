...
class DataAnualAgenciasResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'costo_nuevos' => $this->cnuevos,
            'costo_flotillas' => $this->cflotillas,
            ...
            'utilidad_servicio' => sprintf("%.2f", $this->utilidad_servicio),
            'hyp' => $this->hyp,
            'utilidad_hyp' => sprintf("%.2f", $this->utilidad_hyp),
            'nuevos' => $this->nuevos,
            'utilidad_nuevos' => sprintf("%.2f", $this->utilidad_nuevos), 
            'flotillas' => $this->flotillas,
            'utilidad_flotillas' => sprintf("%.2f", $this->utilidad_flotillas),
            'seminuevos' => $this->seminuevos,
            'utilidad_seminuevos' => sprintf("%.2f", $this->utilidad_seminuevos),
            ...
            'area_nuevos'=> $this->area_nuevos,
            'area_seminuevos'=> $this->area_seminuevos,
            'area_flotillas'=> $this->area_flotillas,
            'area_servicio'=> $this->area_servicio,
            'area_refacciones'=> $this->area_refacciones,
            'area_hyp'=> $this->area_hyp,

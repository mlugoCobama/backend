...
Route::get('energeticos/anual/{id}/{anio}', [EnergeticosController::class, 'showAnual'])->name('energeticos_anual.index-anual');
...
Route::get('dashboard/utilidad-area-pvs/{mes}/{anio}/{subDivision}', [AgenciasController::class, 'getMesPVs'])->name('agencia-nissan.getMesPVs');
/**--------------------------------------

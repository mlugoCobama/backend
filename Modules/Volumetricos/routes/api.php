...
Route::get('/reportes/{id}/descargar-reporte-pdf', [VolumetricosController::class, 'descargarPdf']);
Route::post('/reportes/imprimir-reporte-pdf', [VolumetricosController::class, 'imprimirReporte']);
